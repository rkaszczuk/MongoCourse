## MongoDB 8 - pobranie i uruchomienie serwera - Windows
...
Za pomocą konsoli, z poziomu katalogu ....mongodb-xxxxxxx-8.0.XX\bin uruchamiamy program mongod.
